...
<template>
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <header class="flex items-center justify-between py-4 md:py-8">
      ...
      <nav class="hidden gap-12 lg:flex" aria-label="Main navigation">
      ...
      <div class="flex flex-col items-center border-t border-gray-500 pt-6">
        ...
        <nav class="flex gap-4" aria-label="Socials navigation">
          <a href="#" target="_blank" title="Instagram"
            ...
            <svg aria-label="Instagram" class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
          ...
          <a href="#" target="_blank" title="X"
             class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
            <svg aria-label="X" class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="#" target="_blank" title="LinkedIn"
             class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
            <svg aria-label="LinkedIn" class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="#" target="_blank" title="GitHub"
             class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600">
            <svg aria-label="GitHub" class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                 xmlns="http://www.w3.org/2000/svg">
              <path
