    ...
    <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div class="flex flex-col items-center border-t border-gray-500 pt-6">
        ...
        <nav aria-label="Socials navigation" class="flex gap-4">
          <a class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600" href="#" target="_blank"
             title="Instagram">
            <svg aria-label="Instagram" class="h-5 w-5" fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
          ...
          <a class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600" href="#" target="_blank"
             title="X">
            <svg aria-label="X" class="h-5 w-5" fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600" href="#" target="_blank"
             title="LinkedIn">
            <svg aria-label="LinkedIn" class="h-5 w-5" fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a class="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600" href="#" target="_blank"
             title="GitHub">
            <svg aria-label="GitHub" class="h-5 w-5" fill="currentColor" height="24" viewBox="0 0 24 24" width="24"
                 xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      <div class="py-8 text-center text-sm text-gray-400">© 2024</div>
    </footer>
  </div>
</template>
