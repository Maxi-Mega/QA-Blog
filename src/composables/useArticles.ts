...
const articles: Article[] = [
  {
    ...
    content:
      "In today's fast-paced world, productivity is key to success. Learn five actionable tips to improve your productivity and accomplish more in less time.",
    comments: [],
  },
  {
  ...
  },
  {
    ...
    content:
      "Machine learning is a fascinating field with endless possibilities. Dive into the basics of machine learning, understand key concepts, and embark on your journey to becoming a proficient machine learning practitioner.",
    comments: [],
  },
  {
